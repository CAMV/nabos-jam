...
/// </summary>
public class HotbarSlot : MonoBehaviour, IDropHandler, IDragHandler, IEndDragHandler, IBeginDragHandler
{
    [SerializeField]
    ...
    public void Initialize(IHotbarAction action)
    {
        if (action != null)
        {
            ...
            _iconRenderer.sprite = action.GUIData.Icon;
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        _dummyReference = GUIManager.Instance.GetDummySlot(_myHotbarAction).gameObject;
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        HotbarSlot recieverSlot = eventData.pointerEnter.GetComponentInParent<HotbarSlot>();
        HotbarSlot senderSlot = eventData.pointerDrag.GetComponentInParent<HotbarSlot>();
