...
public class USkillsComponent : MonoBehaviour 
{
    ...
    public void GetSkillInput(Skill skill, VectorSkillType type)
    {
        
        StartCoroutine(GetVectorSkillInputCO(skill, type));
    }
    ...
    /// <param name="skill">Skill to be send the inpu.t</param>
    /// <param name="type">Type of Gizmo required.</param>
    public IEnumerator GetVectorSkillInputCO(Skill skill, VectorSkillType type)
    {
        bool cancel = false;
